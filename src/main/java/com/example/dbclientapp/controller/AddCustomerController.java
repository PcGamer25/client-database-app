...
public class AddCustomerController implements Initializable {
    ...
    /**
     * This method sets up the add customer form
     */
    @Override
    ...
    public void countrySelection(ActionEvent event) throws SQLException {
        ...
        customerDivisionBox.setPromptText("Make a Selection");
    }

    /**
     * This method filters the divisions based on country selection
     */
    public ObservableList<String> getFilteredDivisions(ResultSet rsDivisions) throws SQLException {
        ...
        while (rsDivisions.next()) {
            if (rsDivisions.getInt("Country_ID") == countrySelectedId) {
                filteredDivisions.add(rsDivisions.getString("Division"));
            }
        }
    ...
    /**
     * This method adds the customer to the database
     */
    public void save(ActionEvent event) throws SQLException, IOException {
        ...
        if (!(customerNameField.getText().isBlank()
            ...
            fillFieldsError.setTitle("Add Customer");
